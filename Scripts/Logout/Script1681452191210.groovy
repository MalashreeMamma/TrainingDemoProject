...
WebUI.click(findTestObject('Object Repository/Logout/Page_OrangeHRM/span_Admin'))

WebUI.click(findTestObject('Object Repository/Logout/Page_OrangeHRM/button_Add'))
